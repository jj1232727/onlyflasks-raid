...
const built={raid,seasonLoot,characters,bis,sims,lootHistory,auditActivity,raiderio,specs:Object.keys(bis.lists),refreshedAt:gear.fetchedAt||roster.fetchedAt};
const empty=[
